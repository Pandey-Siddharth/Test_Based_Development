...
class testClaculator(unittest.TestCase):
    ...
    def test_add_number_raises_type_error(self):
        ...
        self.assertRaises(TypeError, self.calculator.add, "60.30.4", "World")

    def test_add_string_numbers_returns_sum(self):
        result = self.calculator.add("50","60")
        self.assertEqual(50+60,result)
